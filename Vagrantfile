...
config.vm.provision "file", source: "/home/ubuntu/networkkeypair.pub", destination: "networkkeypair.pub"
config.vm.provision "shell", inline: "cat networkkeypair.pub >> .ssh/authorized_keys"
config.ssh.username = "vagrant"
config.ssh.keys_only = true
#config.ssh.verify_host_key = false
config.ssh.insert_key = true
#config.ssh.host = "192.168.33.15"
config.ssh.dsa_authentication = false
#config.ssh.extra_args = "-p 22"
config.ssh.private_key_path = "/home/ubuntu/networkkeypair.pub"
